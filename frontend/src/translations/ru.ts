...
export const ru: TranslationContent = {
  ...
  about: {
    quote:
      "« Меня зовут Ирина Мальянц, и я являюсь сертифицированным преподавателей йоги с более чем 10-летним опытом. Я приглашаю вас на мои занятия в Барселоне на английском языке в международной группе! Практика йоги поможет вам обрести спокойствие ума, повысить осознанность, установить глубокую связь с собой и окружающим миром, а также развить гибкость и выносливость! »",
  ...
  footer: {
    phrase1: "Спасибо за интерес к моим занятиям йогой!",
    phrase2: "Надеюсь увидимся!",
  },
};
